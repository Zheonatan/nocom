...
O resto — pré-requisitos, testes, o pipeline de imagens e como uma versão é
publicada — está no [`DEVELOPMENT.md`](DEVELOPMENT.md). Documentos do projeto:
[`PRODUCT.md`](PRODUCT.md) (o que o produto é e por quê),
[`CONTRACT.md`](CONTRACT.md) (comportamento normativo e fronteira IPC),
[`DESIGN.md`](DESIGN.md) (decisões de interface) e o
[`CHANGELOG.md`](CHANGELOG.md) (o que cada versão mudou). Como contribuir está
